...
export default function Editor() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-950 flex flex-col font-sans transition-colors duration-300">
            {/* Toolbar */}
            <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 h-16 flex items-center justify-between px-6 sticky top-0 z-20 w-full shadow-sm">
                <div className="flex items-center gap-4">
                    <Link to="/" className="p-2 -ml-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors">
                    ...
                    <div className="flex flex-col">
                        <input
                            ...
                            className="bg-transparent border-none outline-none text-sm font-semibold text-gray-900 dark:text-gray-100 tracking-wide focus:ring-0 p-0 m-0 w-64 hover:bg-gray-50 dark:hover:bg-gray-800 rounded transition-colors"
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        onClick={saveScript}
                        disabled={saving}
                        className="p-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors disabled:opacity-50"
                    >
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium rounded-lg shadow transition-all hover:shadow-lg active:scale-95"
                    >
            ...
            {/* Editor Workspace */}
            <div className="flex-1 overflow-auto p-8 lg:p-12 flex justify-center bg-gray-100 dark:bg-gray-950 relative">
                ...
                <div className="screenplay-page bg-white shadow-2xl min-h-[11in] w-[8.5in] p-[1in] relative z-10 transition-shadow duration-300">
                    <div ref={editorRef} className="font-mono text-[12pt] text-black leading-tight">
                        {blocks.map(block => (
                            <Block
                                key={block.id}
                                block={block}
